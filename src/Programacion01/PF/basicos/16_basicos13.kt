...
operator fun MyLittleDecimal.plus(a:MyLittleDecimal): MyLittleDecimal{
    val nuevoDecimal:MyLittleDecimal= MyLittleDecimal("0")
    nuevoDecimal.valor = this.valor + a.valor
    return nuevoDecimal
    //return this.sumar(a)
}
fun main() {
